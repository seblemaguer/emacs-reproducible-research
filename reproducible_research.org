...
** TODO Task management - Rendering
(FIXME: how to change)
** TODO Task management - Some important shortcuts
...
- Example:
(FIXME:  adding videos)
- To extend this nice feature, see section (FIXME: ref) in the configuration file
* Org-mode - Writing documents [75%]
** DONE The header
...
** TODO The body - interesting shortcuts
- In the text
...
* Org-mode - Literate programming [25%]
...
* Org-mode/emacs as a "pandoc" equivalent [60%]
** DONE But...why ?!
...
- That is your time to have fun :D
* Conclusion [100%]
** DONE Summary
